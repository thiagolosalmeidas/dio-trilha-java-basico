...
public class Desafio {
    ...
    public static void main(String[] args) {
        ...
        // Lê a entrada do usuário no formato "data,hora,descricao,valor"
        ...
        if (partes.length == 4) {
            ...
            System.out.println("Entrada inválida. Certifique-se de que a entrada esteja no formato correto.");
        }
    }
}
